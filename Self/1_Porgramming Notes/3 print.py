...
#2.Python supports multiple assignment
...
#1. Here  multiplication can be used  but addition , division and substraction can't be  used in case of strings
print("hyy"*10)

# output:hyyhyyhyyhyyhyyhyyhyyhyyhyyhyy

print("abc"+10)   #error i.e. We can't contact string with int
