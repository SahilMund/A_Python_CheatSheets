...
thislist2.pop()   # poped out last element
thislist2.pop(2)  # poped out the 2nd indexed value
print(thislist2)
...
#count  -- how many times a item repeated inside the list
...
num.sort()  #----------it effects to the original list         #num.sort(reverse=False)
...
sorted(num)  #--------------it does not effect to the original list ------------
